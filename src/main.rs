...
fn main() {
    ...
    let true_category: Category = thread::spawn(|| section_name_category()).join().unwrap();
    println!("{}", true_category);
    ...
    //     println!("{}: {}", true_category, true_name);
    // } else {
    //     let mut all_names: HashMap<Category, String> =
    //         find_all_names(&personal, &kojima, &conditions);
    //     println!("True Name\n=========");
    //     println!("{}: {}", true_category, true_name);
    //     all_names.remove_entry(&true_category);
    //     println!("Alternates\n==========");
...
fn find_true_name(
    ...
    match name_category {
        ...
        Category::Occupation => section_occupational(&personal, &kojima, &conditions),
...
fn section_personal_information() -> Information {
    ...
    personal_information.insert("full_name".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is your occupation? Summarize in one -er verb.".bold()
    );
    personal_information.insert("one_word_occupation".to_string(), read!("{}\r"));
    println!(
        "{} ",
    ...
    personal_information.insert("first_pet_breed".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What’s your most embarrassing childhood memory? Summarise it with 2 words.".bold()
    );
    personal_information.insert("two_word_memory".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is the object you'd least like to be stabbed by?".bold()
    );
    personal_information.insert("least_like_stabbed".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is something you're good at? Summarize in one -ing verb.".bold()
    );
    personal_information.insert("good_at".to_string(), read!("{}\r"));
    println!(
        "{} ",
    ...
    personal_information.insert("carrots_one_sitting".to_string(), read!("{}\r"));
    println!("{} ", "What is your greatest intangible fear?".bold());
    personal_information.insert("intangible_fear".to_string(), read!("{}\r"));
    println!("{} ", "What is your greatest tangible fear?".bold());
    personal_information.insert("tangible_fear".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is the last thing you did before starting this worksheet".bold()
    );
    personal_information.insert("last_thing".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "In one word, what condition is your body currently in?".bold()
    );
    personal_information.insert("body_condition".to_string(), read!("{}\r"));
    println!("{} ", "What is your favorite state of matter?".bold());
    personal_information.insert("favorite_state_matter".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is a word your name sort of sounds like?".bold()
    );
    personal_information.insert("name_sounds_like".to_string(), read!("{}\r"));
    println!("{} ", "What is your Zodiac sign?".bold());
    personal_information.insert("zodiac".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "If you could define your personality in one word, what would it be?".bold()
    );
    personal_information.insert("one_word_personality".to_string(), read!("{}\r"));
...
fn section_kojima_information() -> Information {
    ...
    kojima_information.insert("favorite_kurt_russell".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is the last word of the title of your favorite Kubrick film?".bold()
    );
    kojima_information.insert("favorite_kubrick_film".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is the first word in the title of your favorite Joy Division album?".bold()
    );
    kojima_information.insert("favorite_joy_division".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is a scientific term you picked up recently?".bold()
    );
    kojima_information.insert("recent_scientfic_term".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is a piece of military hardware you think looks cool, even though war is bad?".bold()
    );
    kojima_information.insert("cool_military_war_bad".to_string(), read!("{}\r"));
    println!(
        "{} ",
        "What is something you'd enjoy watching Mads Mikkelsen do? Summarize in one word.".bold()
    );
    kojima_information.insert("mads_mikkelsen_amazing".to_string(), read!("{}\r"));
...
fn section_determine_name_conditions() -> Conditions {
    ...
    let man_condition: Condition = match dee_four.roll() {
        1..=3 => Condition::None,
        4 => Condition::Man,
        _ => Condition::None, // TODO: figure out how to eliminate this step; the tiny_die crate ensures rolls are within bounds
    };
...
fn section_name_category() -> Category {
    match Die::new(20).roll() {
        1 => Category::Normal,
        2..=6 => Category::Occupation,
        7..=10 => Category::Horny,
        11..=13 => Category::The,
        14..=17 => Category::Cool,
